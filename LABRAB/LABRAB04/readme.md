...
Вот пример данных их csv-файла:  
...
> вы можете исправить вывод на экран средствами node.js или непосредственно в SQL-запросе функцией так: DATE_FORMAT(day, '%Y.%m.%d')
...
task_09. Оцените время выполнения запроса task_08 без индексации по столбцу count и без индексации.  

> в итоге в таблице будут два индекса: для столбцов name и count  
