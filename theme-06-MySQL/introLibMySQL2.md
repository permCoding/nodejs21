...
То есть для начала создадим вручную через панель phpMyAdmin базу данных и таблицу, добавим там же несколько записаей.  
Если есть база данных и таблица, то как в node.js получить данные из таблицы?  
...
Объект клиента conn в качестве параметра принимает объект с параметрами подключения к базе данных.  
...
- в переменной err код ошибки при возникновении исключительной ситуации при обработке запроса  
