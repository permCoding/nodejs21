...
Существует множество разных фреймворков и шаблонов проектирования. В данной теме мы ограничились только созданием web-приложения по работе с одной таблицой из базы данных MySQL средствами Express.  
